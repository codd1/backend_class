...
int main(){
    ...
    servSin.sin_port = htons(20176);
    servSin.sin_addr.s_addr = inet_addr("127.0.0.1");
    ...
    while(1){
        ...
        numBytes = sendto(s, buf, numBytes, 0, (struct sockaddr*)&clientSin, client_sin_size);    // recvfrom()한 내용을 그대로 sendto()
