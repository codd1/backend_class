...
naver_redirect_uri = 'http%3A%2F%2Flocalhost%3A9176%2Fauth'    # 애플리케이션을 등록 시 입력한 Callback URL 값으로 URL 인코딩을 적용한 값
'''
  본인 app 의 것으로 교체할 것.
...
if __name__ == '__main__':
    app.run('0.0.0.0', port=9176, debug=True)